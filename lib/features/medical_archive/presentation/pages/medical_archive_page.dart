...
class MedicalArchivePage extends StatefulWidget {
  ...
  const MedicalArchivePage({super.key, this.initialTabIndex = 0});
...
class _MedicalArchivePageState extends State<MedicalArchivePage> {
  ...
  void initState() {
    super.initState();
    selectedIndex = widget.initialTabIndex.clamp(0, 1);
  }

  @override
  Widget build(BuildContext context) {
    final tabs = ['Radiographs'.tr(), 'Reports'.tr()];

    final pages = const [RadiographPage(), ReportsPage()];

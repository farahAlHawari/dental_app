...
class FinancialPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _FinancialView(),
    );
  }
}

class _FinancialView extends StatefulWidget {
  const _FinancialView();

  @override
  State<_FinancialView> createState() => _FinancialViewState();
}

class _FinancialViewState extends State<_FinancialView> {
  /// UI filter key: all | PAID | PARTIALLY_PAID | UNPAID
            ...
            BlocConsumer<FinancialBloc, FinancialState>(
              ...
              builder: (context, state) {
                if (state is FinancialSummaryLoading ||
                  ...
                  return const FinancialPageShimmer();
                }

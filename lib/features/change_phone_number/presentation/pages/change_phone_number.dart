...
class _ChangePhonenumberPageState extends State<ChangePhonenumberPage> with SingleTickerProviderStateMixin {
    ...
    child: Stack(
      ...
      children: [
        ...
        AnimatedBuilder(
          ...
          child: Image.asset(
            "assets/images/reset phone.png", // مسار صورة السن عندك
            width: 45,
            color: Colors.white, // لو الصورة أبيض/أسود وبدك تلونيها
                              ...
                              Center(
                                child: Text("Enter your new phone number",
                              ...
                              SizedBox(height: 5,),
                              Center(
                                child: Text("enter your new phone number and we will sent you a varification code.",
                                textAlign: TextAlign.center,
                                style: TextStyle(

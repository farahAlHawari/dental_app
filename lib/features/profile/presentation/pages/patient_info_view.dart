...
class PatientInfoView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _infoRow(context, icon: Icons.cake_outlined, label: "Birth Date", value: dob.isEmpty ? "-" : dob),
        ...
        _infoRow(
          ...
          label: "Allergies",
          value: allergies.isEmpty ? "No known allergies" : allergies,
        ),
        const SizedBox(height: 26),
        SizedBox(
  ...
  Widget _genderChip(Color primary) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(gender.toLowerCase() == "male" ? Icons.male : Icons.female, size: 16, color: primary),
          const SizedBox(width: 4),
          Text(gender.isEmpty ? "-" : gender,
  ...
  Widget _diseasesSection(BuildContext context, Color primary, Color onSurface) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          children: [
            ...
            Text("Chronic Diseases",
                style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: onSurface.withOpacity(0.7))),
          ],
        ),
        const SizedBox(height: 10),
        diseases.isEmpty
            ...
            : Wrap(
                ...
                children: diseases
                    .map((d) => Container(
                          ...
                          decoration:
                              BoxDecoration(color: primary.withOpacity(0.1), borderRadius: BorderRadius.circular(20)),
                          child: Text(d, style: TextStyle(fontSize: 12, color: primary, fontWeight: FontWeight.w500)),
                        ))
                    .toList(),
              ),
      ],
      ...
      children: [
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(label, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: onSurface.withOpacity(0.7))),
              const SizedBox(height: 4),
              Text(value, style: TextStyle(fontSize: 14, color: onSurface)),
            ],
          ),
        ),
      ],
